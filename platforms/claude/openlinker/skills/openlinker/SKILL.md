---
name: openlinker
description: "Route OpenLinker requests to bundled caller and Agent Mode workflows. Use when a Claude Code user asks to discover, call, inspect, cancel, configure, or serve an OpenLinker Agent."
---
...
- Use `serve-openlinker-agent` to configure, diagnose, enable, disable, or
  explain Claude Code Agent Mode and Provider session reuse.
