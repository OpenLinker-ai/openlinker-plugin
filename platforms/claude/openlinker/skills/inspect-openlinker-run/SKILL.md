...
description: "Inspect, monitor, diagnose, or explicitly cancel an OpenLinker Run through the native tools or standalone CLI. Use when a user provides a Run ID or asks about progress, execution transport, failure evidence, outputs, artifacts, or cancellation."
---
